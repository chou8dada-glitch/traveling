...
# 載入環境變數：本機使用 .env，Render 則使用後台 Environment Variables。
...
if __name__ == '__main__':
    if not API_KEY:
        print("Gemini API Key is not set. Gemini features may not work until GEMINI_API_KEY is configured.")
    port = int(os.getenv('PORT', '10000'))          # Render 會用 PORT 環境變數指定埠號
